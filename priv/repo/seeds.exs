...
ruby_channel = Repo.insert!(%Channel{name: "ruby", twitter_hashtag: "ruby"})
rails_channel = Repo.insert!(%Channel{name: "rails", twitter_hashtag: "rails"})
javascript_channel = Repo.insert!(%Channel{name: "javascript", twitter_hashtag: "javascript"})
vim_channel = Repo.insert!(%Channel{name: "vim", twitter_hashtag: "vim"})
